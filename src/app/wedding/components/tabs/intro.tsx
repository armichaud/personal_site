...
const Intro = (): JSX.Element => {
  return (
    <div>
      ...
      <div>
        The site was built as an SPA with React, Typescript, SASS stylijng, and Material UI components. It was deployed to AWS App Runner and used an AWS Lambda to query and update guest RSVP and meal information in an RDS database.
      </div>
      <div>
