        ...
        <div className="flex flex-col items-center justify-center h-full">
            ...
            <div className='flex p-4 justify-between align-center flex-col sm:flex-row max-h-[600px] mt-6'>
                <div className='sm:w-1/2'>
                    <img className="rounded-lg border-double border-4 border-gray-600 max-h-[100%]" src="https://imagedelivery.net/Xh-8qVol1Pftdals16ieKg/ccbbd565-53b4-4780-7fee-b4bcef64c100/public" alt="profile_pic" /> 
                </div>
                <section className="p-6 sm:w-1/2 flex flex-col justify-around mt-12 sm:mt-0">
                    ...
                    <div className='flex flex-col justify-center mb-14 sm:mb-4'>
                        ...
                        <p className='text-center'>
                            Building things in Rust and contributing to open source software. Check out the projects tab for more details!</p>
                    </div>
                </section>
            </div>
        </div>
