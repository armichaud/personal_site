    ...
    return (
      <div>
        ...
        <div className="border p-4 rounded-lg shadow mb-4">
          <h3 className="text-xl font-semibold dark:text-white">Startup Institute | Web Development Fellowship</h3>
        ...
        <div className="border p-4 rounded-lg shadow">
          <h3 className="text-xl font-semibold dark:text-white">Yale University</h3>
